...
from apps.product.views import FilterList, ProductListView, NewProductsView, ProductDetailView, SidebarView, \
    CategoryView
...
urlpatterns = [
    ...
    path('category/<int:category_id>/', include([path('', CategoryView.as_view(), name='subcategories'),
